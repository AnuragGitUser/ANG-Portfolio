        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-[450px] h-[450px]">
              {/* Border ring */}
              <div className="absolute inset-0 rounded-full border-2 border-primary/30 hidden md:block"></div>
              
              <div className="absolute inset-0 animate-spin-slow pointer-events-none select-none hidden md:block">
                <svg className="w-full h-full" viewBox="0 0 450 450">
                  ...
                  <text className="fill-primary text-[15px] font-semibold tracking-[0.49em] uppercase">
