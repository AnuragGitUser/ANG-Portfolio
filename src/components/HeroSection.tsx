...
const HeroSection = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">— I'm Anurag Gurubhetti, fueled by passion, I build exceptional digital experiences that power modern apps. </p>
            </div>
