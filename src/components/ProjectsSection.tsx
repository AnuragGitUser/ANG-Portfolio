...
const ProjectsSection = () => {
  ...
  return <section id="portfolio" className="section-padding overflow-hidden relative">
      <div className="section-container">
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => <Card key={index} className="cursor-target p-6 hover:shadow-xl smooth-transition hover:scale-105">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => <Badge key={techIndex} variant="outline" className="text-xs">
                          {tech}
                        </Badge>)}
                    </div>
