        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 mt-4 flex-wrap">
              ...
              <a href="https://www.linkedin.com/in/prathameshbelge" target="_blank" rel="noopener noreferrer" className="cursor-target px-5 py-2.5 rounded-full border border-black dark:border-white bg-foreground/5 backdrop-blur-sm flex items-center gap-2.5 hover:bg-foreground/10 transition-colors">
